        ...
        <div className="max-w-md w-full space-y-8">
            ...
            <div className="mt-8 space-y-6">
                <div className="rounded-md shadow-sm space-y-4">
                    ...
                    <Link
                        ...
                        border-gray-300 text-sm font-semibold rounded-md text-amazonBlue bg-white hover:bg-gray-50
                        focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amazoneBlue"
                    >
                        Help
                    </Link>
                </div>
            ...
            <div className="mt-8 text-center">
                <p className="text-sm text-gray-600">
                    ...
                    <Link
                        href="/help"
                        className="font-medium text-amazon-blue
                        hover:text-amazon-blue-dark"
                    >
                        Help section
                    </Link>{" "}
                    or{" "}
