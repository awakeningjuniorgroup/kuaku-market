...
import { Category, Product, BRANDS_QUERYResult } from "@/sanity.types";
    ...
    <div className="border-t">
      <Container className="mt-5">
          ...
          <div className="flex items-center justify-between">
            ...
            {(selectedCategory !== null || selectedBrand !== null || selectedPrice !== null) && (
              <button
                ...
                className="text-shop_dark_green underline text-sm mt-2 font-medium hover:text-red-900 hoverEffect"
              >
                Reset Filters
              </button>
            )}
        ...
        <div className="flex flex-col md:flex-row gap-5 border-t border-t-shop_dark_green/50">
          <div
            className="md:sticky md:top-20 md:self-start md:h-[calc(100vh-160px)] md:overflow-y-auto md:min-w-64 pb-5 border-r border-r-shop_btn_dark_green/50"
          >
            {/* Category list */}
            <CategoryList
